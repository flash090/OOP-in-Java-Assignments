...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    for (PointFeature earthquake : earthquakes) {
	    	SimplePointMarker tempMarker = createMarker(earthquake);
	...
	*/
	...
	{  
	    ...
	    int yellow = color(255, 255, 0); // Light 4.0-4.9 
	    ...
	    int blue = color(0,0,255); // minor <4.0 THRESHOLD_LIGHT
	    int red = color(255,0,0); // higher >= 5.0 THRESHOLD_MODERATE
